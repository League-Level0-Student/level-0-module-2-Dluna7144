	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 4; i++) {
			...
			if (randomNumber == 0) {
				...
				JOptionPane.showMessageDialog(null, "Your outfit is on FLEEK");
			}
				...
				JOptionPane.showMessageDialog(null, "Your a very benevolent person");
			}

			else if (randomNumber == 4) {
				JOptionPane.showMessageDialog(null, "You're UNICORN");
			}
